...
ggplot(data = diamonds_sample) +
  geom_smooth(mapping = aes(x = carat, y = price, size = cut))
...
ggplot(data = diamonds_sample) +
  geom_bar(mapping = aes(x = carat, y = price, size = cut, fill = clarity))
...
ggplot(data = diamonds_sample , mapping = aes(x = price, y = carat, color = cut), alpha = 0.3) +
  geom_point() +
  geom_smooth() +
